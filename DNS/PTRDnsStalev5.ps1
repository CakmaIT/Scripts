...
#Get-DnsServerResourceRecord -ZoneName $record.ZoneName -ComputerName 10.5.0.17 -Name $record.Hostname
#Remove-DnsServerResourceRecord -ZoneName $record.ZoneName -ComputerName 10.5.0.17 -Name $record.Hostname -RRType Ptr -Force
$Output2+= $Output
}
}
$records.Count
...
#Get-DnsServerResourceRecord -ZoneName $record.ZoneName -ComputerName gmasgdc03 -Name $record.Hostname -RRType Ptr
#Get-DnsServerResourceRecord -ZoneName $record.ZoneName -ComputerName 10.5.0.17 -Name $record.Hostname
