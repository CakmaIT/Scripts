...
'DRCDC02.acibadem.com.tr'
   ...
   Write-Host $Comp
Resolve-DnsName teamviewer.com -Server $Comp 
Resolve-DnsName ping3.teamviewer.com -Server $Comp
Resolve-DnsName differentia.ru -Server $Comp 
Resolve-DnsName disorderstatus.ru -Server $Comp 
