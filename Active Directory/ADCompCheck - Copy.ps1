...
#$body = @()
$EmailBody = @"
<font face=Tahoma>Active Directory'den <strong>$Deladet</strong> bilgisayar silinmiştir.</font><br />
<font face=Tahoma>Active Directory'de <strong>$disadet</strong> bilgisayar disable edilmiştir.</font><br />
<font face=Tahoma>Acıbadem'den <strong>$RecordsCounter</strong> Mobil'den <strong>$RecordsCounter02</strong> Labmed'den <strong>$RecordsCounter03</strong> eski dns kaydı temizlenmiştir.<br />
<br />
...
Send-MailMessage -to kamil.cicek@acibadem.com -From ActiveDirectory@acibadem.com.tr -SmtpServer smtprelay01.acibadem.com.tr -Subject "AD Computer Password Change Control $Tar" -Encoding ([System.Text.Encoding]::Unicode) -BodyAsHtml $EmailBody -Attachments $attachmentsStaleComp
