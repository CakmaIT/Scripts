...
$reportpath = "C:\Report\WeeklyReport\ADHealthCheck\DC_Health_Check.htm" 

if((test-path $reportpath) -like $false)
{
new-item $reportpath -type file
}
$smtphost = "relay.yildirimgroup.com" 
$from = "adhealtcheck@yildirimgroup.com" 
$email1 = "yasar.abravaya@yildirimgroup.com"
$timeout = "60"
