...
<font face=Tahoma>1000 den fazla dışarıya e-mail gönderen kullanıcıların account bilgileri aşağıdaki gibidir.</font><br />
...
<font face=Tahoma>Spam adreslerine mail atan kullanıcılar aşağıdaki gibidir.</font><br />
<font face=Tahoma>$Victim</font><br />
<font face=Tahoma>Aynı Subject'e sahip olup 15'den fazla dışarıya mail atan kullanıcılar aşağıdaki gibidir.</font><br />
<font face=Tahoma>>$SubjectTable</font><br />
<br /></font></h5>
"@
}
Start-Sleep -s 1
Send-MailMessage -To @('servet.bal@acibadem.com') -Cc $SendtoMail -From $MailSender -SmtpServer $SMTPServer -Subject $Subject -Body $EmailBody -Encoding ([System.Text.Encoding]::Unicode) -BodyAsHTML -Attachments $attachments -Priority High
