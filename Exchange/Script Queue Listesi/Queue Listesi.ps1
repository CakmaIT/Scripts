$session=New-PSSession -ComputerName ASG100EXC05
...
Send-MailMessage -To acibademsistemyonetimi@acibadem.com -From $SendingEmail -SmtpServer $SMTPhost -Subject $EmailSubject -Body $EmailBody -Encoding ([System.Text.Encoding]::Unicode) -BodyAsHTML -Priority High
